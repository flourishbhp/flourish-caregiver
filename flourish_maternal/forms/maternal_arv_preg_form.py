...
class MaternalArvPregForm(SubjectModelFormMixin, forms.ModelForm):
    ...
    antenatal_enrollment_model = 'flourish_maternal.antenatalenrollment'
    appointment = 'edc_appointment.appointment'
    maternal_arv = 'flourish_maternal.maternalarv'
    maternal_preg = 'flourish_maternal.maternalarvpreg'
