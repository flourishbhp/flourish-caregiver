...
'''
 None   [Caregiver] Not interested in participating    Busy during the suggested times   Out of town during the suggested times     Not available during the suggested times  [Caregiver] Prefers not to say why  unwilling.  Caregiver is busy and does not want to participate    Caregiver does not live in study area     Caregiver is not willing to disclose status to their child    Caregiver feels that child is not living with HIV and does not see a need to join the study    Caregiver does not want to join another study   Caregiver has work constraints   Caregiver has fears of joining study/traveling during COVID     Caregiver’s partner does not want/allow them to participate   Caregiver has many other doctor appointments    Caregiver fears stigmatization   Child is busy and does not want to participate    Child is not interested in joining study    Child does not live in study area     Child has fears of joining study/traveling during COVID    Child has many other doctor appointments    Caregiver fears stigmatization      Child is late (has passed away)   Biological mother is late (has passed away), and caregiver is unwilling  Child is unwilling and prefers not to say why   
'''
