...
from ..forms import CaregiverEdinburghPostReferralForm
from ..models import CaregiverEdinburghPostReferral
from .modeladmin_mixins import CrfModelAdminMixin


@admin.register(CaregiverEdinburghPostReferral, site=flourish_caregiver_admin)
class CaregiverEdinburghPostReferralAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = CaregiverEdinburghPostReferralForm
