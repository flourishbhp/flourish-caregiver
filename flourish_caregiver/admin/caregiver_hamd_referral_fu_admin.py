...
from ..forms import CaregiverHamdReferralFUForm
from ..models import CaregiverHamdReferralFU
from .modeladmin_mixins import CrfModelAdminMixin


@admin.register(CaregiverHamdReferralFU, site=flourish_caregiver_admin)
class CaregiverHamdReferralFUAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = CaregiverHamdReferralFUForm
