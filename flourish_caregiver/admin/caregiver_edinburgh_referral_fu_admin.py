...
from ..forms import CaregiverEdinburghReferralFUForm
from ..models import CaregiverEdinburghReferralFU
from .modeladmin_mixins import CrfModelAdminMixin


@admin.register(CaregiverEdinburghReferralFU, site=flourish_caregiver_admin)
class CaregiverEdinburghReferralFUAdmin(CrfModelAdminMixin, admin.ModelAdmin):

    form = CaregiverEdinburghReferralFUForm
