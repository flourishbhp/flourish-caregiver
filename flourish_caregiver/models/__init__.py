...
from .onschedule import OnScheduleCohortAFUSeq, OnScheduleCohortBFUSeq, \
    OnScheduleCohortCFUSeq
...
from .onschedule import OnScheduleCohortASecSeq, OnScheduleCohortBSecSeq, \
    OnScheduleCohortCSecSeq
