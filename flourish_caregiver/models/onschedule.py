...
class OnScheduleCohortAInPerson(OnScheduleModelMixin):
    pass
...
class OnScheduleCohortBInPerson(OnScheduleModelMixin):
    pass
...
class OnScheduleCohortCInPerson(OnScheduleModelMixin):
    pass
