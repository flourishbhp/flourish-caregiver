...
from ..choices import (HIV_STATUS_AWARE,FEEDING_HIV_STATUS,
                       ...
                       AFTER_BIRTH_OPINION,FEEDING_INFLUECE,RETURNED_TO_WORK,FEEDING_AFTER_SIX_MONTHS)
from .list_models import (PregnancyInfluencersList,ReceivedTrainingOnFeedingList,
...
class BreastFeedingQuestionnaire(CrfModelMixin):
    ...
    during_preg_influencers_other = models.CharField(
    ...
    after_deliveryinfluencers_other = OtherCharField(
