...
@tag('relation')
class TestRefererralGroups(TestCase):
    ...
    def setUp(self):
        ...
        self.subject_identifier = self.sh.enroll_prior_participant(
    ...
    def test_caregiver_social_work_required(self):
        ...
        self.caregivercageaid = mommy.make_recipe(
            'flourish_caregiver.caregivercageaid',
            maternal_visit=visit_2000M,
            alcohol_drugs=YES,
        )
        ...
        self.assertEqual(
            CrfMetadata.objects.get(
                ...
                subject_identifier=visit_2000M.subject_identifier,
                visit_code='2000M').entry_status, REQUIRED)

    def test_caregiver_social_work_required_relation(self):
        visit_2000M = mommy.make_recipe(
            'flourish_caregiver.maternalvisit',
            appointment=Appointment.objects.get(
                visit_code='2000M',
    ...
    def test_caregiver_social_work_required_cageaid(self):
        visit_2000M = mommy.make_recipe(
            'flourish_caregiver.maternalvisit',
            appointment=Appointment.objects.get(
                visit_code='2000M',
